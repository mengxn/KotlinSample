 ...
 */
class BaseAdapter<T>(private val layoutId: Int, private val dataList: MutableList<T> = arrayListOf(), private val bind: (View, T) -> Unit) : RecyclerView.Adapter<BaseViewHolder<T>>() {
